...
How concentrated is spend among top customers?
Can customers be meaningfully segmented beyond simple purchase-count rules?
Tech Stack
...
SQL Analysis (database_postgresql.sql)
